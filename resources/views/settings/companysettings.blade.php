        ...
        <div class="sidebar-inner slimscroll">
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li class="active"><a href="{{ route('menus/page') }}"><i class="la la-building"></i><span>Menu</span></a></li>
                    ...
                    <li><a href="{{ route('users/page') }}"><i class="la la-user"></i><span>User</span></a></li>
                </ul>
            </div>
        </div>
    </div>
